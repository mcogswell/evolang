...
def main():
    ...
    job_log_ids = []
    job_times = []
    log_fnames = glob.glob('data/logs/*.log')
    if not args['--refresh'] and pth.exists('data/logs/job_log_cache.json'):
        with open('data/logs/job_log_cache.json', 'r') as f:
    ...
    with open('data/logs/job_log_cache.json', 'w') as f:
